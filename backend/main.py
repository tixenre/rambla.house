...
from routes.portfolio_tokens import router as portfolio_tokens_router
...
app.include_router(portfolio_tokens_router, prefix="/api")  # /api/public/portfolio/brand-tokens (con API key)
